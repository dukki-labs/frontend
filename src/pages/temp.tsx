...
export async function getServerSideProps() {
  ...
  const popluarData = popularList;
  return {
    props: {
      newData: newData,
      popluarData: popluarData,
    },
  };
}
interface Home {
  newData: bookData[];
  popluarData: bookData[];
}

export default function Home({ newData, popluarData }: Home) {
  console.log(newData);
  console.log(popluarData);
  return (
    <>
      <Head>
      ...
      <main className={styles.main}>
        ...
        <div className={`${styles.center} ${styles.paddingBottom}`}>
          ...
          />
          <TextGothic
            text="도서 공유로 사내 구성원과 자연스러운 교류를 쌓아보세요."
            fontWeight={400}
            fontSize={20}
            lineHeight={28}
            color="white"
          ...
          <div className={styles.buttonBox}>
            <div className={`${styles.eachButton} ${styles.main}`}>
              ...
              <Image src={icon_right_arrow} alt="" />
            </div>
